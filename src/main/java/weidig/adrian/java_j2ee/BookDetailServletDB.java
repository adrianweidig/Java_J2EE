...
/**
* AUFGABE 4.2: BookDetailServletDB
* Standard: Servlet 4.0 mit @WebServlet Annotation
* Pattern: Validierung + Error Handling + SQLite DB
*/

@WebServlet("/bookDB")
public class BookDetailServletDB extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (idParam == null || idParam.trim().isEmpty()) {
            ...
            try {
                ...
                BookRepositoryDB bookRepo = new BookRepositoryDB();
        ...
        request.getRequestDispatcher("/views/bookDetailDB.jsp")
