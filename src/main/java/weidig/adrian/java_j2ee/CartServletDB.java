...
/**
* AUFGABE 4.4: CartServletDB
* Standard: Servlet 4.0 mit @WebServlet Annotation
* Pattern: Session-Management mit innerer Klasse + SQLite DB
*/

@WebServlet("/cartDB")
public class CartServletDB extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("/views/cartDB.jsp")
